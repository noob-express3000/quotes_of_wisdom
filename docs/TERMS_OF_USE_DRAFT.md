...
## 3. Trial and Pro access

The production app is intended to begin with a 30-day app-controlled trial that does not require subscription enrollment. After the trial, the app may enter a three-day text-only grace period and then restrict access until Pro is purchased or restored.

Pro may be offered through:

- a weekly auto-renewing subscription;
...
- use the app in a way that violates applicable law or third-party rights; or
- reverse engineer the app except where applicable law or an explicit open-source license permits it.

## 9. Intellectual property and quote sources

The app's original source code and original project material are available under the Apache License 2.0 within the scope stated by the repository's `LICENSE` and `NOTICE` files.

The bundled quote corpus contains public-domain and source-verified historical material. Attribution and provenance records are maintained in the repository. Author attribution, public-domain status, and rights in source editions are separate from rights in the app's original code, visual design, curation, and arrangement.

If you believe material is incorrectly attributed or infringes a right, contact [SUPPORT EMAIL] with the quote and supporting information so it can be reviewed.

## 10. Availability and changes

The developer may fix, update, suspend, or discontinue features when reasonably necessary for security, compatibility, legal compliance, third-party service changes, or product maintenance. Reasonable efforts will be made not to remove paid access arbitrarily, subject to platform rules and circumstances outside the developer's control.
...
To the extent permitted by applicable law, [DEVELOPER OR LEGAL NAME] will not be liable for indirect, incidental, special, consequential, or punitive loss arising from use of or inability to use the app. Any limitation applies only to the extent allowed by the user's mandatory consumer-protection law.
...
[SELECT GOVERNING LAW AND DISPUTE LANGUAGE AFTER OWNER/LEGAL REVIEW. DO NOT PUBLISH THIS PLACEHOLDER.]

## 15. Changes to these Terms

These Terms may be updated when the app, billing model, service providers, or legal requirements change. The effective date will be revised when new Terms are published. Where required, material changes will be communicated through the app or store listing.
...
- [SUPPORT EMAIL]
- [OPTIONAL BUSINESS CONTACT PAGE]
